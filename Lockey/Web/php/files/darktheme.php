...
<html lang="en">
    <head>
        ...
        <!--css-->
        <link href="./css/stylesdark.css" rel="stylesheet" type="text/css">
        <!--aos-->
        <link href="https://cdn.rawgit.com/michalsnik/aos/2.1.1/dist/aos.css" rel="stylesheet">
        <!--shortcut icon logo-->
        <link rel="shortcut icon" href="./stuff/img/smalllockeysindegrablack.svg">
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <div class="container-fluid">
            <a class="navbar-logo" href="./Main.php"><img src="./stuff/img/smalllockeysindegrablack.svg" alt="Logo" class="me-3"style="width: 45px!important; height:auto!important"></a>
